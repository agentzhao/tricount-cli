...
const (
	...
	flagAmountHelp         = "Positive amount in major currency units, not cents. Examples: 12.50 or 1500."
	...
	flagRateHelp           = "How many group-currency units equal 1 unit of --currency. Example: 150 means 1 USD = 150 JPY. Default: look the rate up."
	flagShareHelp          = "One member's share as Name=12.50 or uuid=12.50. Repeat or comma-separate. Shares are positive major units."
